  ...
  <div class="row d-inline-flex">
    <form @submit.prevent="onSubmit">
      <div class="form-group">
        <input type="text" name="title" class="form-control" placeholder="Titre" v-model="this.title" ref="put_title">
      </div>
      <br><br>
      <div class="form-group">
        <textarea name="body" class="form-control" placeholder="Body..." v-model="this.body" ref="put_body"></textarea>
      </div>
      <br><br>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      const {put_id, put_userId, put_title, put_body} = this.$refs;
      ...
      this.axios.put("https://jsonplaceholder.typicode.com/posts/" + id, body)
          .then(response => {
            ...
            // 200 que tous est bon et que c'est mis à jour !
